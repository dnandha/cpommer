...
cdef byte position_is_passage(const byte[constants.BOARD_SIZE][constants.BOARD_SIZE] board, Position position):
...
@cython.boundscheck(False)  # Deactivate bounds checking
@cython.wraparound(False)   # Deactivate negative indexing.
cdef byte position_is_agent(const byte[constants.BOARD_SIZE][constants.BOARD_SIZE] board, Position position):
    cdef int x, y
    x, y = position
    return board[x][y] in [
...
'''
'''
cdef byte position_is_enemy(const byte[constants.BOARD_SIZE][constants.BOARD_SIZE] board, Position position, list enemies):
    cdef int x, y
    x, y = position
...
cdef byte position_is_passable(const byte[constants.BOARD_SIZE][constants.BOARD_SIZE] board, Position position, list enemies):
...
cdef byte position_is_fog(const byte[constants.BOARD_SIZE][constants.BOARD_SIZE] board, Position position):
...
cdef byte position_in_items(const byte[constants.BOARD_SIZE][constants.BOARD_SIZE] board, Position position, list items):
